...
int main(int argc, char **argv) {
  ...
  Kokkos::initialize(argc, argv);
  {
    ...
    Array U    = Array("U", Ngrids, device_params.Ntz, device_params.Nty, device_params.Ntx, Nfields);
    Array Q    = Array("Q", Ngrids, device_params.Ntz, device_params.Nty, device_params.Ntx, Nfields);
